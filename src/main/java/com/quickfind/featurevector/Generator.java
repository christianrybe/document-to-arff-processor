...
public class Generator {
    ...
    public static Instances computeTfIdf(Set<String> taxonomy, Map<String, Double> idfMap, Map<String, Collection<String>> domainsDocs, Set<String> positiveDomains) throws InterruptedException {
